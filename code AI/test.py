...
while  True:
	...
	elif "check yearold" in you or "tính tuổi" in you:
		shin_brain = "enter your birth day: *xx-xx-xxxx* "
		print(shin_brain)
		birth_day = str(input())
		day = int(birth_day[0:2])
		month = int(birth_day[4:5])
		year = int(birth_day[7:])
		yearold(year, day, month)
		age = yearold(year, day, month)
		shin_brain = (f'by now you were born {age}')
		os.system('Pause')
